from autocomplete.lib.constants import EOF_TOKEN, EMPTY_TOKEN, UNKNOWN_TOKEN, EOF_TOKEN_ID, EMPTY_TOKEN_ID, \
    UNKNOWN_TOKEN_ID
from autocomplete.lib.preprocess import read_json
